    ...
    public static World Create() =>
        new WorldBuilder()
            ...
            .AddRoad(TOWN1, TOWN2, cost: 5, days: 3, twoway: true)
                ...
                .AddEnemy    (10, "Лесной волк",        "Похоже, вы забрели куда-то не туда. В такой чаще легко встретить диких лесных животных.")
                    .SetHP       (10)
                    .SetTreasure (1, 3)
                    .SetDeffence (2, 0)
                    .SetAttack   (4, new Dice() { DiceCount = 1, DiceSize = 4, Addition = 0 })
            .Build();
}
